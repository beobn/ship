...
app.controller("categoryController", function ($scope, $http) {
    ...
    $scope.showDataTable = function (index) {
        ...
        var urlGetDataTableSale = `/rest/demo/1/` + $scope.indexPage+`?seach=`+$scope.searchName;
    ...
    $scope.clickTable=function (index){
        var urlGetDataTableSale = `/rest/demo/3?id=`+index;
        $http.get(urlGetDataTableSale).then(function (response) {
    ...
    $scope.addcategory=function (){
        Swal.fire({
            ...
            if(result.isConfirmed) {
                ...
                var urlGetDataTableSale = `/rest/demo/2`;
            ...
            link: function(scope, element, attrs) {
                ...
                element.bind('change', function() {
                    scope.$apply(function() {
                        ...
                        console.log(modelSetter(scope, element[0].files[0].name))
                    });
                });
            }
        };
